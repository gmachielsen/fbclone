...
const getters = {
    ...
    friendButtonText: (state, getters, rootState) => {
        if (rootState.User.user.data.user_id === state.user.data.user_id) {
            return '';
            // two rules above prevents that you can send a friendrequest to your own logged in profile. 
...
const actions = {
    ...
    sendFriendRequest({commit, getters}, friendId) {
        ...
        // means rule 65 - 67. is the frontend prevention to send multiple friend requests by one user. 
