<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button class="flex justify-center py-2 rounded-lg text-sm w-full focus:outline-none" :class="[post.data.attributes.likes.user_likes_post ? 'bg-blue-600 text-white' : '']"
            ...
            <div class="flex my-4 items-center" v-for="comment in post.data.attributes.comments.data">
                ...
                <div class="ml-4 flex-1">
                    <div class=bg-gray-200 rounded-lg p-2 text-sm>
                        <a class="font-bold text-blue-700" :href="'/users/' + comment.data.attributes.commented_by.data.user_id"></a>
